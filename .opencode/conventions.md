...
- **Win condition:** `completed_count >= 3`. Does not stop gameplay.
- When adding new mechanics that affect cooldowns, refills, or mission flow, update `InfoPanel.tsx` content accordingly.
